...
export const meta = {
date: '2019-11-07',
description: `Understand the growth behind JavaScript's hottest web framework and learn why Next.js can help you build web applications faster.`,
image: '/images/learn-next-js/nextjs-trend.png',
slug: 'learn-next-js',
title: 'Why Should You Learn Next.js? - Mastering Next.js'
}
...
![Next.js Trend](/images/learn-next-js/nextjs-trend.png)
...
![React.js Trend](/images/learn-next-js/react-trend.png)
...
[![GitHub Octoberse](/images/learn-next-js/github.png)](https://octoverse.github.com/)
...
![NPM Install Trend](/images/learn-next-js/npm-trend.png)
...
![Companies using Next.js](/images/learn-next-js/companies.png)
...
One more command, and it can be deployed immediately with [Now](https://zeit.co) or [Netlify](https://www.netlify.com/).
